...
import { EMPTY_FORM, TCategory } from '../../_components/typesAndContstants/typesAndContants';
import { slugify } from "../../_components/helperFunctions/helperFunctions";
...
export default function AdminManageCategories({ data }: { data: TCategory[] }) {
