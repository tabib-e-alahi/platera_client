...
function TestimonialCard({ t, featured }: { t: TTestimonial; featured?: boolean }) {
  ...
  return (
    <div className={`testimonial-card${featured ? " testimonial-card--featured" : ""}`}>
      ...
      {/* ── Left rail: rating number + vertical stars ── */}
      <div className="testimonial-card__rail">
        <span className="testimonial-card__rail-rating">
          {t.rating.toFixed(1)}
        </span>

        <div className="testimonial-card__rail-divider" />

        <div className="testimonial-card__rail-stars">
      ...
      {/* ── Body: review text + meal chip + author ── */}
